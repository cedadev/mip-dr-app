# Generated by Django 4.0.6 on 2022-09-30 10:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Record identifier')),
                ('description', models.CharField(max_length=50, verbose_name='Description')),
                ('mip', models.ForeignKey(help_text='Link to Model Intercomparison Project with this objective.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='Endorsed MIP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Title of record', max_length=50, verbose_name='Record Title')),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Record identifier')),
                ('tid', models.CharField(blank=True, help_text='Link to a record which this remark relates to.', max_length=50, null=True, verbose_name='Target identifier: the record ID of the item this refers to.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dimids', models.CharField(blank=True, help_text='List of links to dimensions specified by records in the grids section.', max_length=50, null=True, verbose_name='Identifiers for records in grids section')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('label', models.CharField(help_text='Mnemonic label for record', max_length=50, verbose_name='Record Label')),
                ('title', models.CharField(help_text='Title of record', max_length=50, verbose_name='Record Title')),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='CF Standard Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Title of record', max_length=50, verbose_name='Record Title')),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Record Identifier')),
                ('dimid', models.CharField(blank=True, help_text='List of links to dimensions specified by records in the grids section.', max_length=50, null=True, verbose_name='Identifiers for record in grids section')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Title of record', max_length=50, verbose_name='Record Title')),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Record identifier')),
                ('cid', models.CharField(help_text='Link to a record identifying a choice group.', max_length=50, verbose_name='Choice')),
                ...
                ('vid', models.ForeignKey(help_text='Link to a record defining a variable.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.cmorvar', verbose_name='Variable')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Title of record', max_length=50, verbose_name='Record Title')),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Record identifier')),
                ('cfgid', models.CharField(help_text='A link to a record defining a model configuration options. Configuration options should be defined so that they are either True of False when a model is configured for execution. E.g. does the model have a Boussinesq ocean?', max_length=50, verbose_name='Configuration Option')),
                ...
                ('cid', models.CharField(help_text='Link to a record which  identifies the collection of related variables associated with this configuration option.', max_length=50, verbose_name='Choice -- can provide a link to related variables')),
                ('vid', models.ForeignKey(help_text='Link to a variable which should be treated as requested if the configuration option is appropriately set.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.cmorvar', verbose_name='Variable')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Record Identifier')),
                ('provmip', models.ForeignKey(help_text='The MIP responsible for the original definition of this quantity', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='MIP Defining this Variable')),
                ('sn', models.ForeignKey(help_text='The CF Standard Name is part of an extensive vocabulary maintained within the CF Convention.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.standardname', verbose_name='CF Standard Name')),
                ('unid', models.ForeignKey(help_text='Link to a unit description record.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.units', verbose_name='Link to Units section')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Title of record', max_length=50, verbose_name='Record Title')),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Identifier')),
                ('frid', models.CharField(help_text="Identifier of the 'place' that the flux is from.", max_length=50, verbose_name='Source Identifier')),
                ('toid', models.CharField(help_text="Identifier of the 'place' that the flux is to.", max_length=50, verbose_name='Target Identifier')),
                ...
                ('mip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='Model Intercomparison Project (MIP)')),
                ('vid', models.ForeignKey(help_text="Identifier of the 'CMORvar' associated with the flux.", on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.cmorvar', verbose_name='Variable Identifier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gpid', models.ForeignKey(help_text='Link to a record defining a CMOR table.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.miptable', verbose_name='Identifier for CMOR Tables')),
                ('mip', models.ForeignKey(help_text='Redundant. Specification of a MIP.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='Project')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dids', models.CharField(blank=True, help_text='List of links to the records defining dimensions other than spatial and temporal dimensions.', max_length=50, null=True, verbose_name='Identifiers for records in grids section for dimensions')),
                ...
                ('cids', models.CharField(blank=True, help_text='List of links to the records defining coordinates (dimensions referenced from the variable coordinates attribute).', max_length=50, null=True, verbose_name='Identifiers for records in grids section for coordinates')),
                ...
                ('cmid', models.ForeignKey(help_text='Link to a cell methods record.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.cellmethods', verbose_name='Link to Cell Methods Record')),
                ('spid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.spatialshape', verbose_name='Spatial Shape')),
                ('tmid', models.ForeignKey(help_text='Link to a temporalShape record, defining the temporal dimensions.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.temporalshape', verbose_name='Temporal Shape')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mip', models.ForeignKey(help_text='Link to the MIP which specified this collection of variables. The collection may be re-used by other MIPs through the requestLink records.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='Endorsed MIP defining the variable group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mip', models.ForeignKey(help_text='Name of the Model Intercomparison Project requesting this variable.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='Endorsed MIP')),
                ('vgid', models.ForeignKey(help_text='Link to a requestVarGroup record.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.requestvargroup', verbose_name='Identifier for Variable Group')),
                ('vid', models.ForeignKey(help_text='Link to a CMORvar record.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.cmorvar', verbose_name='Identifier for MIP Output Variable')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mip', models.ForeignKey(help_text='Link to record defining the MIP using this record.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='Endorsed MIP requesting the data')),
                ('refid', models.ForeignKey(help_text='Link to the requestVarGroup record defining the variables associated with this requestLink.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.requestvargroup', verbose_name='Reference to a request Variable Group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mip', models.ForeignKey(help_text='Model Intecomparison Project associated with the requestItem. Redundant because this is specified through the requestLink.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='The MIP making the request.')),
                ('rlid', models.ForeignKey(help_text='Link to a requestLink record, which makes the connection to a variableGroup and a set of objectives.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.requestlink', verbose_name='Identifier of Corresponding Request Link')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vid', models.ForeignKey(help_text='Link to variable record', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.cmorvar', verbose_name='Variable')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='Model Intercomparison Project (MIP)')),
                ('vid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.cmorvar', verbose_name='Variable Identifier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Title of record', max_length=50, verbose_name='Record Title')),
                ('uid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Record identifier')),
                ('oid', models.ForeignKey(help_text='Link to record defining an objective.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.objective', verbose_name='Identifier for a scientific objective')),
                ('rid', models.ForeignKey(help_text='Link to a record defining a requestLink.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.requestlink', verbose_name='Identifier for a request link')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('egid', models.ForeignKey(help_text='Link to the exptgroup record associated with this experiment. Each experiment belongs to one experiment group.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.exptgroup', verbose_name='Identifier for experiment group')),
                ('mip', models.ForeignKey(help_text='Link to a record defining the primary Model Intercomparison Project responsible for the definition of this experiment.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.mip', verbose_name='MIP defining experiment')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='cmorvar',
            name='mtid',
            field=models.ForeignKey(help_text='A link to the record for the MIP table identified by the mipTable attribute.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.miptable', verbose_name='Link to MIP table record'),
        ),
        migrations.AddField(
            model_name='cmorvar',
            name='stid',
            field=models.ForeignKey(help_text='Link to a record describing the structure of the variable (e.g. spatial and temporal dimensions).', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.structure', verbose_name='Link to a record specifying the structure of the variable'),
        ),
        migrations.AddField(
            model_name='cmorvar',
            name='vid',
            field=models.ForeignKey(help_text='The MIP Variable specifies the physical quantity.', on_delete=django.db.models.deletion.CASCADE, to='mip_dr_app_api.var', verbose_name='MIP Variable'),
        ),
    ]
